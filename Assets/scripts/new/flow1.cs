...
public class flow1 : MonoBehaviour
{
    ...
    void Start()
    {
        aObject = boxes[0].transform.Find("balls").gameObject;
    ...
    IEnumerator BallFlow()
    {
        ...
        for (int i = 0; i < clones.Length; i++)
        {
            ...
            clones[14-i].GetComponent<Rigidbody2D>().bodyType = RigidbodyType2D.Dynamic;
        ...
        //yield return new WaitForSeconds(Za);
        StartCoroutine("BallFlow");
        //BoxA[1].SetActive(true);
        //BoxB[3].SetActive(true);
